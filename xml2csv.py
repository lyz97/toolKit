...
class xml2csv:
    ...
    def __init__(self, input_file, output_file, encoding='utf_8_sig'):
...
if __name__ == '__main__':
    xml_path = 'C:/Users/31192/Desktop/简历/决策知识模型/NormalProcedure_TF.xml'
    csv_path = 'C:/Users/31192/Desktop/简历/决策知识模型/test.csv'
    csv_file = xml2csv(xml_path, csv_path)
    csv_file.convert(tag='operation')
